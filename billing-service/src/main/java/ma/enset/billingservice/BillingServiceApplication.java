...
@Bean
    CommandLineRunner start(BillRepository BillRepository,
                            ...
                            ProductItemRestClient productItemRestClient, BillRepository billRepository, ProductItemRepository productItemRepository) {
        return args -> {
            ...
            productPagedModel.forEach(p->{
                ...
                //lié le product a le bill (le bill a un ensemble des produits)
